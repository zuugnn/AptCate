(function ($, undefined) {
    ...
    Dropdown.prototype = {
        ...
        _renderItem: function (item) {
            return '<li><button class="dropdown-item' + (item.selected ? " selected" : "") + '" type="button" value="' + item.value + '">' + item.label + "</button></li>";
        },
        ...
        setSelected: function (indexOrValue, triggerChange) {
            ...
            if (self.el.is("[multiple]")) {
                ...
                if (typeof selectedItems[0] === "number" && selectedItems[0] !== undefined && selectedItems[0] > -1 && selectedItems[0] < dropdownItems.length) {
    ...
    CascadingDropdown.prototype = {
        _init: function () {
            ...
            if (typeof self.options.onChange === "function") {
                dropdowns.bind("click", changeEventHandler);
            }
